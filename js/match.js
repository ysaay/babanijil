...
function startGame(){
   ...
   //High score
    if (!window.localStorage.uiScore) {
        window.localStorage.uiScore = 0;
    }
//draw score  
        function drawScore() {
            ...
            ctx.fillText('score: ' + (uiScore),5,20);
            ctx.fillText('High score: ' + window.localStorage.highScore, 5, 40); 
            ctx.restore();
        }
